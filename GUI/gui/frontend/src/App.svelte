...
<style>
  ...
  .lang-btn{position:fixed;top:8px;right:10px;z-index:100;background:rgba(14,21,14,.9);border:1px solid #2a3d2a;border-radius:4px;padding:3px 5px;cursor:pointer;transition:all .2s;line-height:0}
